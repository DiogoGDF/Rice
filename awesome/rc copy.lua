...
beautiful.init(gears.filesystem.get_themes_dir() .. "tema/theme.lua")
...
tbox_space = wibox.widget.textbox (" ")
...
globalkeys = gears.table.join(
    ...
    -- Change wallpaper
    awful.key({ "Mod1"  }, "n", function () awful.spawn("wallpaper") end,
              {description = "Change wallpaper", group = "screen"}),

    -- Define a keybinding to toggle Picom
    awful.key({ modkey, "Mod1" }, "p", function () 
        awful.spawn.with_shell("pkill picom || picom -b &")
     end, {description = "Toggle Picom", group = "System"}),
...
--beautiful.gap_single_client = truek
