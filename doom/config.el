...
(global-set-key (kbd "ù") 'evil-window-increase-height)
(global-set-key (kbd "ì") 'evil-window-decrease-height)

(use-package writeroom-mode
  :bind (("ẃ" . writeroom-decrease-width)
         ("ŕ" . writeroom-increase-width)))

(require 'iso-transl)
(global-set-key (kbd "ć") (lambda ()
                           (interactive)
                           (insert-char #x0000E7)))
(global-set-key (kbd "Ć") (lambda ()
                           (interactive)
