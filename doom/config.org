...
- [[#trocar-o-ć-por-ç][Trocar o ć por ç]]
- [[#transparencia][Transparencia]]
- [[#pdf][PDF]]
- [[#dired-th][Dired TH]]
- [[#brave-as-browser][Brave as browser]]
- [[#cursor-speed-faster][cursor speed faster]]
...
* PDF
Quando eu abro um pdf ele troca para o modo escuro e esconde a mode-line
#+BEGIN_SRC emacs-lisp
...
* Dired TH
Isso serve pra eu conseguir esconder as hidden files do meu dired
#+begin_src emacs-lisp
...
(setq repeat-delay 0.9)
(setq repeat-interval 0.5)
